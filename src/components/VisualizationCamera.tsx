    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-muted/50 rounded-lg border">
      ...
      <div className="flex flex-wrap items-center gap-3 min-w-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <Select value={selectedCamera} onValueChange={setSelectedCamera}>
              <SelectTrigger
                className={`${isFullscreen ? "w-40" : "w-32"} h-8`}
              >
        ...
        <div className="flex items-center gap-2">
          ...
          <Select
            value={resolution}
            onValueChange={(value: ResolutionKey) => setResolution(value)}
          >
      ...
      {!isStreaming && (
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white bg-black/50">
          ...
          <p
            ...
            } text-center max-w-md opacity-75`}
          >
...
const CameraStream = () => {
  ...
  const {
    ...
    stopCamera,
    restartCamera,
  } = useCameraStream(selectedCamera, resolution);
